...
export default function Login() {
    ...
    const { setAccessToken, setCSRFToken, setIsLoggedIn, setEthereumBalance } = useAuth()
    ...
    async function onSubmitForm(event) {
        ...
        try {
            ...
            setEthereumBalance(response?.data?.ethereum_wallet_balance)
            localStorage.setItem('balance', response?.data?.ethereum_wallet_balance.toString())
